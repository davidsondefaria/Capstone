...
# DAG: Start loading data into stage tables
start_operator >> brazil_cities_to_redshift
start_operator >> enem_to_redshift

# DAG: Load fact tables with data in stage tables
brazil_cities_to_redshift >> candidate_fact_table
brazil_cities_to_redshift >> city_fact_table

enem_to_redshift >> candidate_fact_table
enem_to_redshift >> city_fact_table

# DAG: 
candidate_fact_table >> candidate_dim_table
candidate_fact_table >> student_dim_table
candidate_fact_table >> special_dim_table
candidate_fact_table >> city_dim_table

city_fact_table >> candidate_dim_table
city_fact_table >> student_dim_table
city_fact_table >> special_dim_table
city_fact_table >> city_dim_table
